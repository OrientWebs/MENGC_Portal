<div>
    @can('qualification-create')
        <div class="flex justify-between items-center mb-6">
            <x-breadcrumbs currentUrl="admin/qualifications" />
            <div class="flex justify-end mb-3">
                <x-button.secondary-button type="button" wire:navigate
                    href="{{ route('admin.qualifications', ['action' => 'create']) }}">
    ...
    <x-datatable.table>
        ...
        <x-slot name="tableBody">
            <x-datatable.body>
                ...
                <x-slot name="body">
                    @forelse($qualifications as $index => $record)
                        <tr
    ...
    <div class="p-4 bg-gray-100 dark:bg-gray-800 rounded-b-xl">
        @if ($qualifications)
            {{ $qualifications->links(data: ['scrollTo' => true]) }}
        @endif
    </div>
</div>
